  ...
  return (
    ...
    >
      <div className="container">
        ...
        {/* ─── Team ──── */}
        <RevealBlock className="about-section about-team-section">
          <div className="about-section-label">
            <Users size={16} />
            <span className="text-overline">The Team</span>
          </div>
          <h2 className="text-headline">DataForge</h2>
          <p className="text-body" style={{ maxWidth: 560, marginBottom: 'var(--space-8)' }}>
            Built for the Pathway × Rime Hackathon. We believe technology should amplify 
            human capability, not replace human expression.
          </p>
